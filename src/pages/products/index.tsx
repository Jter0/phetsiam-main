...
const ProductCard = ({ product }: { product: ProductType }) => {
  ...
  return (
    <Link
      ...
      className="mt-5 project-card w-[277px] block cursor-pointer relative shadow-[0px_3px_39px_0px_#0000001A] hover:sm:shadow-[0px_4px_24px_0px_#00000040] transition-shadow overflow-hidden group"
