...
function HeaderSearch({ isSearchOpen }: { isSearchOpen: boolean }) {
  ...
  useEffect(() => {
    ...
    const search = autocomplete<ProductHit>({
      ...
      classNames: {
        form: "!bg-transparent !border-none  !outline-black w-72 px-2 text-white py-2 placeholder:text-white",
        inputWrapperSuffix: "!hidden !bg-transparent outline-none",
      },
      insights: true,
      getSources({ query }) {
        return [
