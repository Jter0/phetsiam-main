      ...
      {tagType == "input" ? (
        <>
          ...
          <input
            ...
            onBlur={handleBlur}
            onChange={onChange}
            className="input bg-white text-[#112a3f] w-full z-10 focus-visible:outline-none"
            type={inputType}
            required={required}
            value={value}
          />
        ...
        <>
          ...
          <textarea
            ...
            onBlur={handleBlur}
            onChange={onChange}
            className="input bg-white h-56 text-[#112a3f] w-full z-10 pl-[0.5rem] focus-visible:outline-none"
            value={value}
            rows={10}
            cols={12}
